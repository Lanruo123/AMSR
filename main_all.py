    ...
    for dataset in datasets:
        ...
        for Proportion in Proportion_list:
            ...
            for repeat in range(repeats):
                ...
                acc,precision,recall,f1,auc = run_Adversarial_model(dataset,train_loader, valid_loader, test_loader, network_number)
                acc_t.append(acc)
